...
var BambeeGulp = (function() {
  ...
  function BambeeGulp(gulp) {
    ...
    _paths = {
      src: {
        ...
        spritesRetina: src + '/sprites/**/*-retina.png',
      },
      dist: {
        root: dist,
        css: dist + '/css',
  ...
  BambeeGulp.prototype.registerTaks = function() {
    ...
    _gulp.task('compile:scss:main', ['clean:css:main', 'lint:scss:main'], self.taskCompileScssMain);
    ...
    _gulp.task('reload', ['copy'], self.reload);
  ...
  BambeeGulp.prototype.taskLintScssMain = function() {
    ...
    var path = JSON.parse(JSON.stringify(_paths.src.scss.main));
  ...
  BambeeGulp.prototype.taskSprites = function() {
    var spriteData = _gulp.src(_paths.src.sprites)
      .pipe(_plugins.spritesmithMulti({
        imgName: 'sprite.png',
    ...
    var imgStream = spriteData.img
      .pipe(_gulp.dest('src/img/sprites'));

    var cssStream = spriteData.css
      .pipe(_gulp.dest('src/css/sprites'));

    return _merge(imgStream, cssStream);
  }
  ...
  BambeeGulp.prototype.taskImages = function() {
    return _gulp.src(_paths.src.images)
  ...
  BambeeGulp.prototype.taskCopy = function() {
    return _gulp.src(_paths.src.copy, {nodir: true})
      .pipe(_gulp.dest(_paths.dist.root));
  };
  ...
  BambeeGulp.prototype.taskWatch = function() {
    ...
    watcher.push(_gulp.watch(_paths.src.copy, ['copy', 'reload']));
  ...
  BambeeGulp.prototype.reload = function() {
    _plugins.livereload.reload('index.php');
  ...
  BambeeGulp.prototype.onChangeCallback = function(event) {
    ...
    console.log('\n' + _plugins.util.colors.blue(time) + ' ' + event.type + ':\n\t' + event.path + '\n');
  };
